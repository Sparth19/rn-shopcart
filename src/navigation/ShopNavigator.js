...
import MyChatScreen from '../screens/users/MyChatScreen';
...
const DrawerNavigator = (props) => {
  ...
  return (
    <Drawer.Navigator
        ...
        return (
          <DrawerContentScrollView {...props}>
            <DrawerItem
              ...
              onPress={() => {
                props.navigation.navigate('MyAccountNavigator');
              }}
              icon={() => (
                <Avatar.Text
                  size={70}
      ...
      />
      <Drawer.Screen
        name="MyChatNavigator"
        component={MyChatNavigator}
        options={{
          title: 'My Chats',
          drawerIcon: ({color}) => (
